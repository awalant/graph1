//Use d3 to select the id #hivMand
d3.select("#hivMand")

    //Use event listeners to track when #hivMan is clicked on
    .on("click", function () {
                ...
                var states = svg4.selectAll("path")
                    ...
                    .on("mousemove", function (d) {
                        ...
                        if (d.properties.name === "Arizona") {
                            label = d.properties.name + " cannot have HIV education that 'promotes' a 'homosexual lifestyle' nor positively depicts homosexuality";
                        } else if (d.properties.name === "Oklahoma") {
                            label = d.properties.name + " has mandated HIV education that teaches 'homosexual activity' is 'responsible for contact with the AIDS virus'";
                        } else {
